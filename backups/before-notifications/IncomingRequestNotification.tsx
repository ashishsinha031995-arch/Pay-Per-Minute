  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center text-center gap-5 relative z-10 w-full flex-1">
        ...
        {/* Details - Shifted below timer */}
        <div className="text-xs text-slate-400 font-mono flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 p-4 bg-slate-900/60 border border-slate-800/50 rounded-2xl w-full max-w-sm sm:max-w-md mx-auto shadow-inner">
          ...
          <span className="text-slate-700 hidden sm:inline">•</span>
          <div className="flex items-center space-x-1.5">
            <span className="text-[10px] text-slate-500">Est. Earn:</span>
